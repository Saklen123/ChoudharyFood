...
function Koreanfood() {
    ...
    let Food1 = Food.filter((ele) => ele.titlename === 'KoreanFood');
                ...
                <div className="col-12">
                    <div className="d-flex justify-content-between align-items-center">
                        <h2 className="text-warning fw-bold mb-0">
                            <i className="fas fa-bowl-food me-2"></i>
                            Korean Food
                        </h2>
                        <button
                    ...
                    <p className="text-muted mb-0">Authentic Korean cuisine with bold flavors</p>
                </div>
            </div>
